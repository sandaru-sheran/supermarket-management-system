...
public class RegistorManagerForm extends javax.swing.JFrame {
    
    Array array;
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RegistorManagerForm.class.getName());


    public RegistorManagerForm(Array array) {
        initComponents();
        this.array=array;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registor Manager");
    ...
    private void registorButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registorButtonActionPerformed
       if(!(nameTextField.getText().trim().isEmpty() ||usernameTextField.getText().trim().isEmpty() ||passwordTextField.getText().trim().isEmpty() ||mobileNumberTextField.getText().trim().isEmpty())){
        User user=array.userNameSearch(usernameTextField.getText());
        if (!(user.username.equals("-1"))){
            ...
            if(array.addUser(new User(nameTextField.getText(), usernameTextField.getText(), passwordTextField.getText(), mobileNumberTextField.getText(),true))){
                    JOptionPane.showMessageDialog(
                    this, 
